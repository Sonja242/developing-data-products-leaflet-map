...
The map was created in R with the **leaflet** package. It uses open map tiles and a small curated dataset of Amsterdam locations. Hovering over a marker reveals its name; selecting it opens a short description. Nearby locations form marker clusters when the reader zooms out. The layer control, overview map, and metric scale make the different themes and their geographic context easy to explore.
